...
const COPY = {
  "zh-CN": { save: "保存为工作记录", schedule: "安排周五 17:00 周报", view: "查看工作记录", undo: "撤销", refresh: "查询结果", pending: "正在确认保存结果，尚未确认成功", deleted: "已删除", saved: "已保存工作记录", report: "已归档报告", scheduled: "已安排周报", queued: "报告任务已创建", failed: "操作未完成", noMaterial: "暂无素材，请先补充工作记录", succeeded: "报告已归档", running: "报告生成中", retry: "等待重试" },
