const en = {
  ...
  entries: "Tasks", daily: "Daily reports", weekly: "Weekly reports", schedules: "Schedules",
  weekFormat: "Week {week} ({range})", currentWeek: "Current week", previousYear: "Previous year", nextYear: "Next year", noReports: "No reports in this period.",
  currentWeekMark: "This week", weekPicker: "Choose week", preview: "Preview",
  from: "From", to: "To", project: "Project", allProjects: "All projects", add: "Add task",
...
const zh: WorklogLabels = {
  ...
  entries: "任务", daily: "日报", weekly: "周报", schedules: "报告定时设置", from: "开始日期", to: "结束日期", project: "项目", allProjects: "全部项目", add: "添加任务",
  weekFormat: "第{week}周（{range}）", currentWeek: "回到本周", previousYear: "上一年", nextYear: "下一年", noReports: "这个时间段内还没有报告。",
  currentWeekMark: "本周", weekPicker: "选择周次", preview: "预览",
  ...
  deleteQuestion: "删除所选记录？此操作无法撤销。", linked: "关联报告", keepReports: "保留报告并标记来源已变更", deleteReports: "同时删除关联报告", clearRange: "删除筛选任务", generate: "生成报告", queued: "已加入生成队列，请在运行记录中查看结果。",
  addSchedule: "添加定时计划", name: "名称", time: "时间", weekday: "星期", timezone: "时区", next: "下次运行", runs: "最近运行", pause: "暂停", resume: "启用", enabled: "已启用", paused: "已暂停",
...
const ja: WorklogLabels = {
  ...
  entries: "タスク", daily: "日報", weekly: "週報", schedules: "レポート予定", from: "開始日", to: "終了日", project: "プロジェクト", allProjects: "すべて", add: "タスクを追加",
  weekFormat: "第{week}週（{range}）", currentWeek: "今週へ", previousYear: "前年", nextYear: "翌年", noReports: "この期間のレポートはありません。",
  currentWeekMark: "今週", weekPicker: "週を選択", preview: "プレビュー",
...
const ko: WorklogLabels = {
  ...
  entries: "작업", daily: "일일 보고", weekly: "주간 보고", schedules: "보고 일정", from: "시작일", to: "종료일", project: "프로젝트", allProjects: "전체 프로젝트", add: "작업 추가",
  weekFormat: "{week}주차 ({range})", currentWeek: "이번 주", previousYear: "이전 연도", nextYear: "다음 연도", noReports: "이 기간의 보고서가 없습니다.",
  currentWeekMark: "이번 주", weekPicker: "주차 선택", preview: "미리보기",
